...
**Purpose:** Entry point for new developers and quick start guides
...
**What to Do Next - Week by Week Action Plan**
- Weekly action plan with daily tasks
- Clear deliverables for each phase
- Progress tracker and success criteria
- Pro tips and common questions answered
- **Read this if:** You want a step-by-step weekly guide

### [QUICK_START.md](./QUICK_START.md)
**Get Running in 30 Minutes**
- Environment setup (backend, frontend, database)
- Supabase configuration
- First migration and test
...
- Detailed setup for backend, frontend, and CI/CD
...
2. **[QUICK_START.md](./QUICK_START.md)** - Setup requirements
...
- **Development:** See [04-development](../04-development/) for feature breakdown
